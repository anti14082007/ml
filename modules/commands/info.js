...
💮 Tên: Văn Huy
💮 Biệt danh: kaiser
❎ Ngày tháng năm sinh: 03/09/2006
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m76 x 55kg
💘 Mối quan hệ: <3 có ny
🌎 Quê quán: Trà Vinh
👫 Gu: giản dị
...
💻Contact💻
☎ SĐT&Zalo: ko nói
🌐 Facebook: https://www.facebook.com/100075401250019
    - TikTok: ko nói
    - Instagram: ko nói
✉️ Email: ko nói`,
...
if (args[0] == "user") { 
    ...
    var gender = sex == 2 ? "Nam" : sex == 1 ? "Nữ" : "Trần Đức Bo";
    var callback = () => api.sendMessage({body:`🌺 𝙄𝙣𝙛𝙤 𝙪𝙨𝙚𝙧 🌺\n💳Tên: ${name}` + `\n🏝URL cá nhân: ${url}` + `\n💦Tên người dùng: ${sn}\n🐧UID: ${args[1]}\n💘Giới tính: ${gender}\n❄️Kết bạn bot: ${b}`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID);   
       return request(encodeURI(`https://graph.facebook.com/${args[1]}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(fs.createWriteStream(__dirname+'/cache/1.png')).on('close',() => callback()); module.exports.config = {
    name: "info",
    version: "1.0.0",
    hasPermssion: 0,
    credits: "HungCho Mod By NguyenHoangAnhProCoder",
