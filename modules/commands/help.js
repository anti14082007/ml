...
🌟 𝐒𝐮̛̉ 𝐝𝐮̣𝐧𝐠: "${prefix}𝗵𝗲𝗹𝗽 + 𝘁𝗲̂𝗻 𝗹𝗲̣̂𝗻𝗵" 𝗰𝗵𝗼 𝗯𝗶𝗲̂́𝘁 𝗰𝗵𝗶 𝘁𝗶𝗲̂́𝘁 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗹𝗲̣̂𝗻𝗵
💝 𝐁𝐨𝐭 𝐤𝐡𝐨̛̉𝐢 𝐜𝐡𝐚̣𝐲 𝐛𝐨̛̉𝐢 𝐀𝐝𝐦𝐢𝐧 𝐕𝐨̃ 𝐍𝐡𝐚̣̂𝐭 𝐇𝐨𝐚̀𝐧𝐠 
💘𝐓𝐫𝐞̂𝐧 𝐋𝐚̀ 𝐓𝐨𝐚̀𝐧 𝐁𝐨̣̂ 𝐋𝐞̣̂𝐧𝐡 𝐂𝐨́ 𝐓𝐫𝐨𝐧𝐠 𝐅𝐢𝐥𝐞 𝐁𝐨𝐭 𝐂𝐮̉𝐚 𝐀𝐝𝐦𝐢𝐧 QPhong [❗] 
🔰 𝗩𝘂𝗶 𝗟𝗼̀𝗻𝗴 𝗞𝗵𝗼̂𝗻𝗴 𝗦𝗽𝗮𝗺 𝗕𝗼𝘁 𝗗𝘂̛𝗼̛́𝗶 𝗠𝗼̣𝗶 𝗛𝗶̀𝗻𝗵 𝗧𝗵𝘂̛́𝗰 [❗]`;
    return axios.get('https://apinhathoanghaikhkhsau.nhhoangepdaiqaa.repl.co/imggaiditbu').then(res => {
    let ext = res.data.data.substring(res.data.url.lastIndexOf(".") + 1);
    let callback = function () {
