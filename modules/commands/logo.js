...
module.exports.handleReply = async ({ api, event, handleReply }) => {
    ...
    case 4:
      content.subname = input;
			...
			api.unsendMessage(handleReply.messageID);
			let c = content;
			let res = await axios.get(encodeURI(`https://api-test.sp20bse.repl.co/tad?color1=${c.color1}&color2=${c.color2}&ten_chinh=${c.namee}&ten_phu=${c.subname}`), { responseType: "arraybuffer" })
