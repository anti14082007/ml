...
try {
  ...
  const canvas = Canvas.createCanvas(500, 670);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "𝐊𝐢𝐦𝐨𝐜𝐡𝐢, 𝐕𝐢ệ𝐭 𝐀𝐧𝐡 đã 𝐦𝐮𝐚 𝐝ầ𝐮 ă𝐧 𝐫 𝐧è 𝐜ù𝐧𝐠 𝐧𝐡𝐚𝐮 𝐥à𝐦 𝐧𝐡á𝐲 𝐧𝐡é 🤤🤤"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
